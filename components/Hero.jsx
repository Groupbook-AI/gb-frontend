        ...
        <div className="mx-auto max-w-2xl shrink-0 lg:mx-0 lg:pt-8">
          ...
          <div className="mt-24 sm:mt-32 lg:mt-16">
            <a href="#" className="inline-flex space-x-6">
              <span className="rounded-full bg-cyan-500/10 px-3 py-1 text-sm/6 font-semibold text-cyan-400 ring-1 ring-inset ring-cyan-500/20">
                What&apos;s new
              </span>
          ...
          Group Travel and Event Booking, Simplified
          </h1>
          <p className="mt-8 text-pretty text-lg font-medium text-gray-400 sm:text-xl/8">
          Effortlessly manage group travel with confidence, ensuring a smooth and seamless experience for any group event.
          </p>
