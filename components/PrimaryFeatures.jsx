...
const features = [
  {
    name: 'Save Time',
    description:
      'Simplify hotel block management and reduce hours of calls, emails, and contracts. Groupbook saves you over 20 hours per event.',
    icon: DeviceUserIcon,
    screen: InviteScreen,
  },
  {
    name: 'Maximize Earnings',
    description:
      'Earn an industry-leading 90% commission and mark up wholesale rates while offering clients discounts and ease.',
  ...
  },
  {
    name: 'Add Value',
    description:
      'From sourcing rooms to checkout, Groupbook’s concierge service provides support every step of the way, ensuring a seamless experience.',
    ...
    >
      <Container>
        <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-3xl">
          ...
          Built for Event Planners Who Demand More. See for Yourself.
          </h2>
          <p className="mt-2 text-lg text-gray-400">
          Our platform empowers you to take control of group bookings with ease, efficiency, and a focus on delivering exceptional travel experiences. If others make it complicated, we make it effortless.
          </p>
        </div>
      </Container>
