    ...
    <nav className="flex space-x-4">
      {links.map(({ label, href, dropdown }, index) => (
        ...
        >
          <Link
            href={href}
            className="relative -mx-3 -my-2 rounded-lg px-3 py-2 text-sm text-gray-400 transition-colors delay-150 hover:text-gray-200 hover:delay-0"
          >
